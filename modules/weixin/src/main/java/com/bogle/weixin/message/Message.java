...
import com.bogle.weixin.defines.Event;
import com.bogle.weixin.defines.MsgType;
import com.bogle.weixin.message.menu.ScanCodeInfo;
import com.bogle.weixin.message.menu.SendLocationInfo;
import com.bogle.weixin.message.menu.SendPicsInfo;
import com.bogle.weixin.xstream.annotation.XStreamCDATA;
...
public class Message implements Serializable {
    ...
    private long createTime = System.currentTimeMillis() / 1000;//消息创建时间 （整型）
     ...
     */
    @XStreamAlias("Event")
    private Event event;//事件类型，subscribe(订阅)、unsubscribe(取消订阅)
