package com.bogle.weixin.defines;
...
public enum Event {
    ...
    kf_close_session {//多客服关闭会话
        ...
        @Override
        public String toString() {
            return "kf_close_session";
        }
    },
    kf_create_session {//多客服创建会话

        @Override
        public String toString() {
            return "kf_create_session";
        }
    },
    TEMPLATESENDJOBFINISH {//在模版消息发送任务完成后，微信服务器会将是否送达成功作为通知，发送到开发者中心中填写的服务器配置地址中。
